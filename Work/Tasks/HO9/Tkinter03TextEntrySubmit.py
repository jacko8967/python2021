...
Label(window, text="Enter a string and press submit", bg="white", font="none 12 bold").grid(row=1, column=0, sticky=W)
# using grid layout
...
Label(window, text="\n Your string", bg="white", font="none 12 bold").grid(row=4, column=0, sticky=W)
#using grid layout


#output text field - Text (12:40 mins)
outputTextField = Text(window, width=75, height=6, wrap=WORD, background="white")
outputTextField.grid(row=4, column=0, sticky=W)
