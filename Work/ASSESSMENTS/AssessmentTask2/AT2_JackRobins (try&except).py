...
def onClickSubmitButton():                                      # submit button event handler
        ...
        if (userEnteredText.find(".") != -1): #searching for a ".""
            pass
            if (userEnteredText.find("@") != -1): #searches for a "@" if "." is found
                try:                                                    # (15:00 mins) exception 
                    ...
                    definition = "There is no match found for your entered email address" #modified definition key to state no match found for email address
            pass
        else:
            definition = "You have entered an invalid email address" #added message stating incorrect email address format
